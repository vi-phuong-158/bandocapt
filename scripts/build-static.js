...
const ENTRY_HTML = new Set(['index.html', 'chat-embed.html', 'can-bo/index.html', 'dong-gop/index.html']);
const files = [
    'index.html',
    'chat-embed.html',
    'can-bo/index.html',
  ...
  'lib/accommodation-beta.js',
    ...
    'styles/public-location-contribution.css',
    'assets/logo.png',
