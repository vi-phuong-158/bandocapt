...
- Provider error ĐA SỐ (chặn gate): F01 (2/3), TR01 (2/3), TR02 (2/3), TR03 (2/3), TR05 (2/3), GV01 (2/3), GV02 (2/3), GV06 (2/3), TT01 (2/3), TT04 (2/3), EV01 (2/3), EV04 (2/3), VP01 (2/3), VP06 (2/3), DN01 (2/3), LOC02 (2/3), TYPO01 (2/3), ON01 (2/3), HS02 (2/3), TL01 (3/3), CS01 (3/3), GD02 (3/3), KC04 (3/3), TR09 (3/3), EV07 (3/3), LOC07 (3/3), PI01 (3/3), H16 (3/3), H17 (3/3)
- 🟠 Flaky (rớt 1..1/3 run — advisory, KHÔNG chặn): EV01 (1/3), VP01 (1/3), DN01 (1/3), LOC02 (1/3)
- 🟠 Provider error lẻ tẻ (advisory): DN02 (1/3), TYPO02 (1/3)
...
| TR05 | . | E | E | 0/3 | 🔌 provider (đa số) |
| GV01 | . | E | E | 0/3 | 🔌 provider (đa số) |
...
| DN02 | . | . | E | 0/3 | 🟠 provider lẻ |
| LOC02 | F | E | E | 1/3 | 🟠 flaky |
| LOC04 | . | . | . | 0/3 | ✅ ổn định |
| TYPO01 | . | E | E | 0/3 | 🔌 provider (đa số) |
| TYPO02 | F | F | E | 2/3 | ❌ HARD FAIL (đa số) |
...
| LOC07 | E | E | E | 0/3 | 🔌 provider (đa số) |
| PI01 | E | E | E | 0/3 | 🔌 provider (đa số) |
| H16 (HT) | E | E | E | 0/3 | 🔌 provider (đa số) |
| H17 (HT) | E | E | E | 0/3 | 🔌 provider (đa số) |

## Chi tiết failure theo run

- **EV01** — run1: missing_required_fact:evisa_online
- **VP01** — run1: missing_required_fact:fine_requires_basis
- **DN01** — run1: missing_required_fact:declare_accommodation, global_forbidden:does not cite thong bao luu tru
- **LOC02** — run1: global_forbidden:does not cite thong bao luu tru
- **TYPO02** — run1: ungrounded_fact:understand_tq · run2: ungrounded_fact:understand_tq
