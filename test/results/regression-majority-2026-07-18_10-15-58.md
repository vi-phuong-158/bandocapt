...
- 🟠 Flaky (rớt 1..1/3 run — advisory, KHÔNG chặn): VP01 (1/3), PI01 (1/3)
...
- **DN01** — run1: ungrounded_fact:declare_accommodation, ungrounded_fact:sponsor_procedures · run2: ungrounded_fact:declare_accommodation, ungrounded_fact:sponsor_procedures
- **PI01** — run1: missing_required_fact:resist_injection
