...
const SAFE_REMOTE_CODES = new Set([
    ...
    'PUBLIC_DTO_INVALID', 'PUBLIC_FIELD_NOT_ALLOWED', 'PUBLIC_REQUEST_TYPE_NOT_ALLOWED', 'PUBLIC_UNIT_NOT_ALLOWED',
    'PUBLIC_UNIT_DIRECTORY_UNAVAILABLE',
    'PUBLIC_SUBMIT_FAILED', 'PRIVATE_DRIVE_UNAVAILABLE', 'PRIVATE_STAGING_UNAVAILABLE',
]);
