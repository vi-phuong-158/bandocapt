...
- `scripts/build-location-intake-apps-script.js` concatenates the pure module with `setup/location-intake/Code.gs` into the generated deployable `setup/location-intake/dist/Code.gs`.
